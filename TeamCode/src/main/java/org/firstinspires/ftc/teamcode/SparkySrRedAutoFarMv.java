...
@Config
public class SparkySrRedAutoFarMv extends SparkySrCommonLinearOpMode {

    @Override
    public void runOpMode() throws InterruptedException {

        SparkySrAutonActionsFactory actionsFactory = new SparkySrAutonActionsFactory(true, SparkySrAutonActionsFactory.StartPose.START_AT_SMALL_TRIANGLE);
